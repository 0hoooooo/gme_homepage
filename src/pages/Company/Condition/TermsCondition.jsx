    ...
    },
    {
      ...
      sub_content: [
        ...
        },
        {
          ...
          kor_title: "제4조(지정계좌)",
          content:
            "① 회사는 ‘소액해외송금업무에 사용할 계좌인 것으로 소액해외송금업 등록(변경등록 포함) 당시 지정한 회사명의의 금융회사개설 계좌’(이하 ‘지정계좌’라 합니다.)를 통해서만 고객에게 자금을 지급하거나 고객으로부터 자금을 수령할 수 있습니다. ② 회사는 제1항의 지정계좌에 관한 내용을 회사 홈페이지 등에 게시하고 이를 최신 내용으로 관리하여야 합니다.",
        },
        {
          id: 5,
          kor_title: "제5조(수수료)",
